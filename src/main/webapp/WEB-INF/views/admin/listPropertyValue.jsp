        ...
        <div id="page-inner">
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <a href="addPropertyValueView?product_id=${product.id}&category_id=${product.category_id}" class="btn btn-success" style="background-color: #fc66a2;border-color: #fc66a2">添加属性值</a>
                </div>
            </div>
            <br>
